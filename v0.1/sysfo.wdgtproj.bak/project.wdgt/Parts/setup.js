...
function setupParts() {
    ...
    CreateText('text11', { text: 'FDO' });
    CreateText('text4', { text: 'site: www.codeuniversity.com' });
    CreateText('text5', { text: 'by: Steve Dickinson' });
    CreateText('text6', { text: unescape('SysfO %u00A9 2009 Code University') });
    CreateShape('roundedRectangleShape2', { rightImageWidth: 5, leftImageWidth: 5 });
    CreateText('text7', { text: 'Sys' });
}
